...
namespace AddressBookProblem
{
    ...
    internal class AddressBook
    {
        ...
        public AddressBook()
        {
            string json = File.ReadAllText(@"D:\.Net\Assignment\Day27\AddressBookProblem\AddressBookProblem\File.json");
            if (json.Length > 0)
            {
        ...
        public void addPerson(Person p)
        {
            ...
            File.WriteAllText(@"D:\.Net\Assignment\Day27\AddressBookProblem\AddressBookProblem\File.json", jsonData);
        }
    }
